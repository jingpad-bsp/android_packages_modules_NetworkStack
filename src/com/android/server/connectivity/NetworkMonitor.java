...
public class NetworkMonitor extends StateMachine {
    ...
    private CaptivePortalProbeResult sendParallelHttpProbes(
        ...
        //Sometimes routers don't respond correctly, for example, it should reply http code 204,
        //but reply http code 200,so if one result is 204, then we regard it as successful.
